package com.example.calcolatoremassamolare;
...
public class MainActivity extends AppCompatActivity {
    String composto;
    EditText editTextPersonalName2;
    Button button;
    ...
    String[] symbols = {"H", "He",
            ...
            "Cs", "Ba", "La",
            "Ce", "Pr", "Nd", "Pm", "Sm", "Eu", "Gd", "Tb", "Dy", "Ho", "Er", "Tm", "Yb", "Lu",
            "Hf", "Ta", "W", "Re", "Os", "Ir", "Pt", "Au", "Hg", "Tl", "Pb", "Bi", "Po", "At", "Rn", "U"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);
        editTextPersonalName2 = (EditText) findViewById(R.id.editTextTextPersonName2);
        button = findViewById(R.id.button);
    }

    public void onClick(View v) {
        composto = editTextPersonalName2.getText().toString();
        double mm = calculateMolarMass(composto);

        TextView myTextView = (TextView) findViewById(R.id.textView);
        if (mm > 0) {
            myTextView.setText("La massa molare è: " + mm + " g/mol");
        } else {
            myTextView.setText("Il composto inserito non è valido");
        }
    }
